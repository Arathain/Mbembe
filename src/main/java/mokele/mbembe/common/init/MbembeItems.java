...
public class MbembeItems {
    ...
    public static final Item DODO = create("dodo", new Item(new FabricItemSettings().group(ItemGroup.FOOD).food(new FoodComponent.Builder().hunger(3).saturationModifier(0.4F).build())));
    public static final Item COOKED_DODO = create("cooked_dodo", new Item(new FabricItemSettings().group(ItemGroup.FOOD).food(new FoodComponent.Builder().hunger(8).saturationModifier(0.6F).build())));
